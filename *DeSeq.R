...
counts_data <- read.csv("xxxx.csv", row.names = 1)
...
colData <- read.csv("0.3pfoaPPARKOmlsampleinfo.csv", row.names = 1)
...
# Save results
write.csv(res, " dds.csv", row.names = TRUE)
