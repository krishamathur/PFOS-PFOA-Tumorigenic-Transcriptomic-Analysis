# ============================================================
# PFOS/PFOA Biomarker Analysis: Stouffer Integration and Visualization
# ============================================================

# -------------------------------------------
# Required Packages: ggplot2, ggrepel, dplyr
library(ggplot2)
library(ggrepel)
library(dplyr)
...
# Load dataset
df_raw <- read.csv("xx.csv", row.names = 1)
...
# -------------------------------------------
# Create Volcano Plot for PFOS/PFOA Combined
...
# ============================================================
# Biomarker Expression Figures (Z-scores)

# Load biomarker dataset
biomarker_data <- read.csv("xx.csv")
